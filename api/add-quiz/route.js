...
export async function GET(request) {
	...
	return NextResponse.json({ message: `${await request.json()}` }, { status: 200 });
}

export async function POST(request) {
	let {quizTitle, quizSubtitle, questions } = await request.json();
	...
	con.query(
		`INSERT INTO quizAnswers VALUES ('${quizTitle}', '${quizSubtitle}', '${JSON.stringify(questions)}', 'no')`,
